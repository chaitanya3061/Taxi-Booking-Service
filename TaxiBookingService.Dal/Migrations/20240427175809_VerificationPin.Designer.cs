...
namespace TaxiBookingService.Dal.Migrations
{
    ...
    [Migration("20240427175809_VerificationPin")]
    partial class VerificationPin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaxiBookingService.Dal.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 101,
                            CountryCode = "+91",
                            CreatedAt = new DateTime(2024, 4, 27, 17, 58, 9, 69, DateTimeKind.Utc).AddTicks(7571),
                            Email = "chaitu@gmail.com",
                            IsActive = false,
                            IsDeleted = false,
                            Name = "Chaitu",
                            PasswordHash = new byte[] { 101, 37, 162, 4, 55, 114, 135, 94, 198, 5, 42, 28, 244, 239, 43, 207, 90, 149, 52, 107, 75, 134, 67, 50, 100, 55, 156, 90, 160, 73, 77, 103, 153, 62, 142, 116, 22, 155, 98, 42, 223, 110, 222, 149, 118, 133, 152, 132, 58, 87, 145, 195, 117, 208, 218, 230, 130, 55, 209, 37, 143, 11, 175, 90 },
